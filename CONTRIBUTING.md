...
### Currently accepted
Current accepted work: **#128 Make saved show templates apply to new episodes**. A PR must complete that issue's Acceptance through the normal product workflow.
