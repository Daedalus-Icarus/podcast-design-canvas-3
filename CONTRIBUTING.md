...
### Currently accepted
Current accepted work: **#118 Add timed visual moments to preview and export**. A PR must complete that issue's Acceptance through the normal product workflow.
