...
### Currently accepted
Current accepted work: **#121 Save custom layouts as reusable show templates**. A PR must complete that issue's Acceptance through the normal product workflow.
